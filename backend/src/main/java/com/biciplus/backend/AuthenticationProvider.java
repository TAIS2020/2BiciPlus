...
@Component
public class AuthenticationProvider<T extends Person> extends AbstractUserDetailsAuthenticationProvider {
	...
	protected UserDetails retrieveUser(String userName,
		...
		return Optional.ofNullable(token).map(String::valueOf).flatMap(authenticationService::findByToken).orElseThrow(
